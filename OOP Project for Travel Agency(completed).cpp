	...
	cout<<"\n Admin name has been completed"<<endl;
	
	} //de
	
	};//1stclass........manageManue
	...
	static int cusID; //to make customer id static
	...
	static float lastCabCost;// to make last cab cost static
	...
	static float hotelCost;//to make hotel cost static
	
	void hotels()
	{
		
	string hotelNo[] = {"Avendra Hotel", "City Hotel", "Alpine Hotel"};
	...
	cout << "\tLive a Luxury at Avendra Hotel: Rs.15000.00" << endl;
	...
	cout << "\nYou have successfully booked Standard Pack at Avendra Hotel" << endl;
	...
	cout << "\nYou have successfully booked Premium Pack at Avendra Hotel" << endl;
	cout << "Goto Menu and take the receipt" << endl;
	...
	cout << "\nYou have successfully booked Luxury Pack at Avendra Hotel" << endl;
	cout << "Goto Menu to take the receipt" << endl;
	...
	cout << "You have successfully booked Family Pack at City Hotel" << endl;
	cout << "Goto Menu and take the receipt" << endl;
	}
	else if (packChoice1 == 2){
	...
	cout << "You have successfully booked Couple Pack at City Hotel" << endl;
	cout << "Goto Menu and take the receipt" << endl;
	}
	else if (packChoice1 == 3){
	...
	cout << "You have successfully booked Single Pack at City Hotel" << endl;
	cout << "Goto Menu and take the receipt" << endl;
	}
	else{
	...
	cout << "-------WELCOME TO Alpine Hotel-------\n" << endl;
	cout << "Set in tropical gardens on the banks of the Opra river While Seeing Elephants" << endl;
	...
	cout << "You have successfully booked Alpine Hotel Special Pack" << endl;
	cout << "Goto Menu and take the receipt" << endl;
	...
	class Chargers : public Booking, Cabs, Customer //Multiple Inheritance of some other classes to Charges
	{
	...
	{
	outf << "--------------------PakistanTime  Travel Agency--------------------" << endl;//name for travel agency............. 
	outf << "------------------------Receipt--------------------------" << endl;
	outf << "__________________________________________________________" << endl;
	outf << "**********************************************************" << endl;
	outf << "__________________________________________________________" << endl;
	...
	cout << "\t\t *PakistanTime  Travels *\n" << endl; // name for travel agency
	cout << "-------------------------Main Menu--------------------------" << endl;
